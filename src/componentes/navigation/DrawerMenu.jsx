...
/*
 * ESTILOS ANTERIORES DEL DRAWER (BACKUP)
 * Para restaurar el estilo anterior, reemplaza los estilos desde "drawerHeader" hasta "logoutText" con estos:
 * 
    drawerHeader: {
        backgroundColor: '#018f64',
        paddingTop: 30,
 ...
 * 
 * Y en el JSX del header, reemplazar el LinearGradient con:
 *     <View style={styles.drawerHeader}>
 *         <Image
 *             source={{ uri: avatarUrl }}
 *             style={styles.avatar}
 ...
 *     </View>
 * 
 * Y en los menuItems, reemplazar el TouchableOpacity complejo con:
 *     <TouchableOpacity
 *         key={itemIndex}
 *         style={styles.menuItem}
 *         onPress={() => {
